...
module.exports = (deployer, network, accounts) => {
    deployer.then(async () => {
        ...
        // sending eth to the evaluator so It can performe the exercice :

        await web3.eth.sendTransaction({from : accounts[1],to : Evaluator.address,value : web3.utils.toBN(web3.utils.toWei("0.005", 'ether'))});
